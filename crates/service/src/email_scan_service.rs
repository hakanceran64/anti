...
/// Email scanning service statistics
...
/// Email scanning service configuration
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl EmailScanService {
    /// Create a new email scanning service
    ...
    pub async fn start(&self) -> Result<(), AntivirusError> {
        ...
        // We need to clone the scanner for the monitor
        // This is a simplified approach - in a real implementation, we'd use Arc<dyn EmailScanner>
    ...
    /// Update statistics with scan result
...
/// Trait for email scanning service operations
#[async_trait]
