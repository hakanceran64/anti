...
impl NativeMessagingHost {
    ...
    /// Read messages from stdin (browser extension)
    ...
    /// Handle URL reputation check request
...
mod tests {
    ...
    fn test_url_check_request_serialization() {
        let request = UrlCheckRequest {
            url: "https://malicious-site.com".to_string(),
            tab_id: Some(123),
        };
